...
$(function () {
  ...
  $demoSettings.append(
	...
	+ '<div class="form-group">'    
    + '<input id="expand_on_hover" type="checkbox"data-enable="expandOnHover" class="pull-right chk-col-grey"/> '
	+ '<label for="expand_on_hover" class="control-sidebar-subheading">'
